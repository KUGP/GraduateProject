...
def obtain_search_args():
    ...
    parser.add_argument('--dataset', type=str, default='cityscapes',
                        choices=['pascal', 'coco', 'cityscapes', 'kd','nightcity','video'],
    ...
    parser.add_argument('--crop_size', type=int, default=512, # 321
    ...
    parser.add_argument('--checkname', type=str, default="FCN",
